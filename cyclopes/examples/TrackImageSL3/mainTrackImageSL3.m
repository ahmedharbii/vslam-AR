...
tracking_param.changereference = 0; %for reference patch changing
...
capture_params.homedir = '/MIR Erasmus/VSLAM/cyclopes/'
%for the street:
% capture_params.data_dir = '/MIR Erasmus/VSLAM/Versailles_canyon/Right/'
capture_params.data_dir = '/MIR Erasmus/VSLAM/Versailles_canyon/Left/'
%for underwater: 
